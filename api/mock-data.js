...
const PRS = [
  ...
  },
  {
    ...
    diff: [
      { type: "ctx", text: "  public void recalcLines()" },
      { type: "ctx", text: "  {" },
      { type: "add", text: "+     while select forUpdate purchLine" },
      { type: "add", text: "+         where purchLine.PurchId == this.PurchId" },
      { type: "add", text: "+     {" },
      { type: "add", text: "+         select firstonly inventTable" },
      { type: "add", text: "+             where inventTable.ItemId == purchLine.ItemId;" },
      { type: "add", text: "+         purchLine.LineAmount = purchLine.PurchQty * price;" },
      { type: "add", text: "+         purchLine.update();" },
      { type: "add", text: "+     }" },
      { type: "ctx", text: "  }" },
    ],
    commentDraft:
